...
# Welcome message
WELCOME_MESSAGE = """🍣 *Добро пожаловать в Суши у Милены!*
...
🍣 *Суши у Милены* - доставка свежих суши и японской кухни в г. Столбцы.
    ...
    for sub in subscribers:
        try:
            await context.bot.send_message(
                ...
                text=f"📢 *Новость от Суши у Милены:*\n\n{message}",
                parse_mode=ParseMode.MARKDOWN
            )
            success_count += 1
        except Exception as e:
...
def main():
    ...
    application.add_handler(CallbackQueryHandler(repeat_order_callback, pattern="^repeat_order_"))
